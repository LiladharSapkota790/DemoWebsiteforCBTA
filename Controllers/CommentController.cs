...
namespace DemoWebsiteforCBTA.Controllers
{
    public class CommentController : Controller
    {
        ...
        {
            var comments = db.Comments.Include(c => c.Member).Include(c => c.Post);
        ...
        public ActionResult Create([Bind(Include = "PostID,CommentID,Memberid,CommentText,CommentedDate")] Comment comment)
        {
            ...
            ViewBag.Memberid = new SelectList(db.Members, "Memberid", "MFirstName", comment.Memberid);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostID,CommentID,Memberid,CommentText,CommentedDate")] Comment comment)
        {
            if (ModelState.IsValid)
            {
